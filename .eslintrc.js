module.exports = {
    ...
    "rules": {
        ...
        "@typescript-eslint/naming-convention": [
          "error",
          {
            selector: "variableLike", format: ["camelCase", "UPPER_CASE", "PascalCase"], filter: { regex: '__', match: false }
          },
          {
            selector: "variable", format: ["camelCase","UPPER_CASE","PascalCase"], filter: { regex: '__', match: false }
          },
          {
          ...
          {
            selector: "parameterProperty", format: ["camelCase"], modifiers: ['private', 'protected', 'public', 'readonly'], leadingUnderscore: "require"
          },
          {
        ...
        "@typescript-eslint/tslint/config": [ // this block is added just for porting some of the useful rules from TSLint to ESLint
          "error",
          {
